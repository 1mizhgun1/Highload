...
Важно, что количество Master-nodes должно быть нечетным, чтобы при голосовании за нового мастера всегда был перевес у одной из нод.
...
|----------------|-------------|-----|-------|:---------------------------------:|
| API Gateway    | 1220        | 13  | 3 Гб  |                 -                 | 
| Auth           | 300         | 3   | 1 Гб  |                 -                 |
| User           | 1000        | 10  | 2 Гб  |                 -                 |
| Page           | 1000        | 10  | 2 Гб  |                 -                 |
| Search         | 300         | 3   | 1 Гб  |                 -                 |
| Kafka consumer | 800         | 8   | 2 Гб  |                 -                 |
| Attach         | 800         | 8   | 2 Гб  |                 -                 |
| Redis          | 500         | 10  | 20 Гб |               1 Тб                |
| PostgreSQL     | 5000        | 50  | 40 Гб |              300 Tб               |
| ElasticSearch  | 1500        | 15  | 6 Гб  |              700 Тб               |
| Ceph           | 7000        | 70  | 15 Гб |              2000 Тб              |
| ClickHouse     | 5000        | 50  | 10 Гб |               10 Тб               |
| Envoy          | 1220        | 13  | 10 Гб |                 -                 |
...
Сервисы `API Gateway`, `Auth`, `User`, `Page`, `Search`, `Kafka consumer`, `Attach` будут жить в одинаковых по количеству ресурсов подах, поэтому под них выделим одинаковые сервера, которые назовем `Kube node`. Суммарно на всех `Kube node` должно быть не менее чем 13x17=221 Гб RAM и 55x17=935 CPU.
